...
const UserDataCollect = () => {
    ...
    const [projectData, setProjectData] = useState({ 'projectTitles': { pTitle1: "Project Title " }, 'projectDesc': { pDescription1: "Your projects will display here , with Bullet Points" } })
    const [educationData, setEducationData] = useState({ 'educationTitles': { eTitle1: "Education Title" }, 'educationDesc': { eDescription1: "Education Description And Background" } })
    const [workData, setWorkData] = useState({ 'workTitles': { wTitle1: "Work Title" }, 'workDesc': { wDescription1: "Work Description are Shown here " } })
    const [personalData, setPersonalData] = useState({ profileImage: 'https://www.w3schools.com/howto/img_avatar.png', name: "Your Name", summary: 'Your Summary Will Be Display Here', profile: "Work Profile", address: "Address Line", phone: "Phone Number", email: "Email Address", skill: 'A summary of Your Skills,List your skill, essential skills, and proficiencies.', })
    const [awardData, setAwardData] = useState({ awards: 'Put In your Achievement' })
        ...
        <>
            <div id="form-collect">
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <hr />
                    <Button onClick={handleEducationClick} className='my-3 w-100' colorScheme='blue' variant='solid'>Add Education</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <hr />
                    <Button disabled={checkProj} onClick={handleProjectClick} className='my-3 w-100' colorScheme='blue' variant='solid'>Add Projects</Button>
                    {
                ...
                <div id="form-personal" className='mb-2'>
                    ...
                    <hr />
                    <Button disabled={checkWork} onClick={handleWorkClick} className='my-3 w-100' colorScheme='blue' variant='solid'>Add Experience</Button>
                    {
